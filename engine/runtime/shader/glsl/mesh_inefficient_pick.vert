...
{
    mat4 RenderObject_matrices[m_mesh_per_drawcall_max_instance_count];
...
void main()
{
    highp mat4 RenderObject_matrix = RenderObject_matrices[gl_InstanceIndex];
    ...
    gl_Position = proj_view_matrix * RenderObject_matrix * vec4(in_position, 1.0);
