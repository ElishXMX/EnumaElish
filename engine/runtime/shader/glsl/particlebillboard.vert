...
void main()
{
    ...
    vec2       RenderObject_position   = vertex_buffer[gl_VertexIndex];
    ...
    {
        world_position =
            size_x * right_diection * RenderObject_position.x + size_y * up_direction * RenderObject_position.y + anchor_location;
    }
    else
    {
        ...
        world_position =
            size_x * side_dir * RenderObject_position.x + size_y * project_dir * RenderObject_position.y + anchor_location;
    }
