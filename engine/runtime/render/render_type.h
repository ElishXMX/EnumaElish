...
#define RHI_FALSE                           false
    ...
    enum RHIStructureType : int
    {
        ...
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_RenderObject_FEATURES = 1000211000,
        ...
        RHI_STRUCTURE_TYPE_SHADER_BINDING_TABLE_CREATE_INFO_KHR = 1000150019,
        ...
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_RenderObject_FEATURES_KHR = RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_RenderObject_FEATURES,
    ...
    // 光线追踪加速结构构建类型枚举
    enum RHIAccelerationStructureBuildTypeKHR : int {
        RHI_ACCELERATION_STRUCTURE_BUILD_TYPE_HOST_KHR = 0,     // 主机构建
        RHI_ACCELERATION_STRUCTURE_BUILD_TYPE_DEVICE_KHR = 1,   // 设备构建
        RHI_ACCELERATION_STRUCTURE_BUILD_TYPE_HOST_OR_DEVICE_KHR = 2, // 主机或设备构建
        RHI_ACCELERATION_STRUCTURE_BUILD_TYPE_MAX_ENUM_KHR = 0x7FFFFFFF
    };
    ...
    // 内存分配标志位枚举
    enum RHIMemoryAllocateFlagBits {
        RHI_MEMORY_ALLOCATE_DEVICE_MASK_BIT = 0x00000001,
        RHI_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT = 0x00000002,
        RHI_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT = 0x00000004,
        RHI_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT_KHR = RHI_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT,
        RHI_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_KHR = RHI_MEMORY_ALLOCATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT,
        RHI_MEMORY_ALLOCATE_FLAG_BITS_MAX_ENUM = 0x7FFFFFFF
    };
    typedef uint32_t RHIMemoryAllocateFlags;
}

namespace Elish
{
    enum class Elish_IMAGE_TYPE : uint8_t
    {
        Elish_IMAGE_TYPE_UNKNOWM = 0,
        Elish_IMAGE_TYPE_2D
    };
    ...
    public:
        ...
        Elish_IMAGE_TYPE   m_type { Elish_IMAGE_TYPE::Elish_IMAGE_TYPE_UNKNOWM};
...
template<>
struct std::hash<Elish::MeshSourceDesc>
{
    size_t operator()(const Elish::MeshSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
template<>
struct std::hash<Elish::MaterialSourceDesc>
{
    size_t operator()(const Elish::MaterialSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
